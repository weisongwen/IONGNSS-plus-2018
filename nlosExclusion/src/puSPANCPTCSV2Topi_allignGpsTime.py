...
class csv2Topi():
    ...
    def fastReadCSV(self,GNSSBegin, GNSSEnd):
        ...
        self.Fcsv_GNSS = csv.reader(open('/home/wenws/20180131/sv_data20180131.csv',
...
if __name__ == '__main__':
    ...
    csv2Topi_.fastReadCSV(311138000,311284000) # the value is provided by bag file in topci '/novatel_data/bestpos'
